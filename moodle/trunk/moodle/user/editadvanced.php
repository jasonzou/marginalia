<?php // $Id: editadvanced.php,v 1.21.2.7 2008/02/26 06:39:11 scyrma Exp $
    ...
    if ($usernew = $userform->get_data()) {
		...
		// Update username in annotations
		// (annotations depend on username not id because they are designed to be
		// independent of Moodle internal architecture)
		if ( $user->username != $usernew->username )
			annotations_update_username( $user->username, $usernew->username );
